...
else if(bt_ir_data == 9){mode=1; Speed=200;} //Auto Line Follower Command
...
long IRremote_data(){
     if(results.value==0xFF30CF){IR_data=1;}  
else if(results.value==0xFF18E7){IR_data=2;} 
else if(results.value==0xFF7A85){IR_data=3;} 
else if(results.value==0xFF10EF){IR_data=4;} 
else if(results.value==0xFF38C7 || results.value==0xFFA857){IR_data=5;} 
else if(results.value==0xFF5AA5){IR_data=8;} 
else if(results.value==0xFF4AB5){IR_data=9;} 
else if(results.value==0xFF52AD){IR_data=10;}
return IR_data;
}
